...
def main():
    ...
    menu = ConsoleMenu("2207 Team 18", "APK and Java file obfuscation tool", formatter=menu_format)
    # item1 = MenuItem("Item 1", menu)

    # Create a menu item that calls a function
    function_item = FunctionItem("Upload an APK or Java file", uploadFile)
    function_item3 = FunctionItem("Decompile APK", decompile)
    function_item4 = FunctionItem("Recompile into APK", recompile)
    function_item2 = FunctionItem("Obfuscate", obfuscate)
    ...
    # submenu = SelectionMenu(["", "item2", "item3"], title="Selection Menu",
